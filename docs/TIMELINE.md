...
- **Lesson 2.3: Why Paint Logic Fails on Screens**: Correcting paint-based predictions with the additive RGB model.
- **Lesson 2.4: Subtractive Color for Digital Designers**: Explaining differences between screen colors and physical materials through CMYK, gamut, and production conditions.
- **Lesson 2.5: Seeing Pixels as Light, Not Paint**: Examining RGB subpixels and how surrounding luminance changes an accent's prominence.
- **Milestone 2: Mix for Screen**: Predict how RGB channels combine, then answer three questions about screen color.
...
- **Milestone 3: Build a UI Palette in Code**: Build a five-role interface theme with HSL controls, then answer three questions about role tokens, alpha, and gradients.
...
- **Milestone 6: Color System Capstone**: Audit semantic color roles, repair a dark theme, and answer four questions about maintaining color systems.
