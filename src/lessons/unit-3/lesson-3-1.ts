...
export const lesson3_1: LessonConfig = {
  ...
  steps: [
    ...
    {
      text: 'Designers encounter color values and references in Cascading Style Sheets (CSS) files, design tool inspectors, browser developer tools, component libraries, and design token files. A color may appear as a raw value or as a named reference to a design token.',
    },
    {
