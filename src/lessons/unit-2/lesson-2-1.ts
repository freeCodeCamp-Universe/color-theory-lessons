...
export const lesson2_1: LessonConfig = {
  ...
  steps: [
    ...
    {
      text: 'Additive mixing combines emitted light. Screens, projectors, and light-emitting diode (LED) signs use red, green, and blue (RGB) light. Increasing a channel adds light. Combining all three channels at full intensity produces white.',
    },
    {
