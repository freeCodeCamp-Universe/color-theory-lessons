      ...
      questions: [
        {
          ...
          choices: [
            { id: 'a', label: 'Use one saturated accent while nearby elements use neutral colors', isCorrect: true, explanation: 'The single accent differs from its surroundings, so it receives the most color emphasis.' },
            { id: 'b', label: 'Give every action a different saturated color', isCorrect: false, explanation: 'Several saturated colors create competing signals instead of one focal point.' },
            { id: 'c', label: 'Use the same accent treatment on every action', isCorrect: false, explanation: 'Matching treatments give the actions equal color emphasis.' },
        ...
        },
        {
          ...
          choices: [
            { id: 'a', label: 'Increase the contrast ratio between the text and background', isCorrect: true, explanation: 'Changing the text color, the background color, or both can raise their contrast ratio.' },
            { id: 'b', label: 'Change the typeface to monospace', isCorrect: false, explanation: 'Changing the typeface does not repair the color pair\'s contrast ratio.' },
        ...
        },
        {
          ...
          choices: [
            { id: 'a', label: 'Separate that section from the content around it', isCorrect: true, explanation: 'A background change creates a visible boundary between page sections.' },
            { id: 'b', label: 'Guarantee that every text color in the section is readable', isCorrect: false, explanation: 'Each text and background pair still needs its own contrast check.' },
            { id: 'c', label: 'Give every element in the section equal emphasis', isCorrect: false, explanation: 'Elements can still use different color treatments to establish hierarchy within the section.' },
            { id: 'd', label: 'Show that every element in the section is interactive', isCorrect: false, explanation: 'A section background groups or separates content; it does not make each element interactive.' },
          ],
        },
      ],
    },
