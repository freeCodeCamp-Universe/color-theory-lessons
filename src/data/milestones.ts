  ...
  parts: [
    {
      ...
      briefing: 'Assign a swatch to each role. At least seven assignments must be correct. Then identify the color conflict in the palette.',
      successMessage: 'At least seven swatches have the correct roles, and you identified the weak luminance separation between warning and error.',
      pointValue: 3,
    },
    {
      kind: 'challenge',
      ...
      briefing: 'Adjust the theme until text reaches 4.5:1 against the card surface, the card reaches the 1.2:1 exercise threshold against the page, and the action reaches 3:1 against the card.',
      successMessage: 'The text, card surface, and action color meet all three contrast targets.',
      pointValue: 3,
    },
    {
      kind: 'quiz',
