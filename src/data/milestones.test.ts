...
describe('Milestone 3 configuration', () => {
  it('has one four-point challenge, three quiz questions, and a five-point pass threshold', () => {
    ...
    expect(quizQuestions).toBe(3);
    expect(challengePoints + quizQuestions).toBe(7);
    expect(milestone.passThreshold).toBe(5);
...
describe('Milestone 4 configuration', () => {
  it('has one four-point challenge, three quiz questions, and a five-point pass threshold', () => {
